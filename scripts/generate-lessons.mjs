...
/**
 * Bảng âm Hán Việt của TỪNG CHỮ, nạp một lần cho cả lượt chạy.
 *
 * Dùng để điền cột âm Hán Việt cho những từ có chữ Hán mà nguồn để trống — toàn
 * bộ phần 総まとめ N3, vì sách đó không chú âm. Xem `han-viet-compose.mjs`.
 */
